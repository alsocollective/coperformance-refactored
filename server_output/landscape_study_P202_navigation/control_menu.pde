...
void setupGUI(){
  ...
  sliders[si++] = controlP5.addSlider("cam_scale",0.1,5,left,top+posY+20,len,15);
  sliders[si++] = controlP5.addSlider("curve_amp",1,5000,left,top+posY+40,len,15);
